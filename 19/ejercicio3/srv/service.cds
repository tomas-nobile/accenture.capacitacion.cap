...
service api {
  ...
  entity shopproduct as projection on my.shopProduct{*,shop.name as shopName, product.name as productName};
...
action modifyQuantity(data:shopproduct) returns String;
}
